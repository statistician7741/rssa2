...
<div class="topic_create">
  ...
  <div class="col-md-4 side-bar">
    ...
    <div class="panel panel-default corner-radius help-box">
      ...
      <div class="panel-body">
        <ul class="list">
          <li>Spamming is not permitted please keep all your posts as constructive as possible.</li>
		      <li>There will be no posts meant to offend or hurt any other member, in a manner which is offensive or inflammatory. This includes flaming or instigating arguments.</li>
		      <li>There will be no racial, ethnic, gender based insults or any other personal discriminations.  This will not be tolerated and can lead to immediate suspension.</li>
		      <li>Pornography, warez, or any other illegal transactions may NOT be linked in any shape or form.</li>
      </div>
    </div>
  </div>
</div>
